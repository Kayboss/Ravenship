...
// 3. Go to Email Templates → Create two templates (paste the HTML below into the "Content" tab, use "Code" mode):
//    Template A ("admin_notify"): variables → {{admin_name}}, {{admin_email}}, {{user_name}}, {{user_email}}, {{user_role}}
//    Template B ("approved"): variables → {{to_name}}, {{to_email}}, {{user_name}}, {{user_role}}
